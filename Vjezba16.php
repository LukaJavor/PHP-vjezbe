...
<main>
    ...
    <?php
        $con=mysqli_connect("localhost", "root","","vj16");
        $query = "INSERT INTO users (firstname, lastname, email, username, password, countrycode)  
